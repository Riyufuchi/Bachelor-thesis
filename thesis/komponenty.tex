...
\section{IComponent}
\lstinputlisting[language=C++, caption={IComponent}, label={lst:cpp_icomp}]{../code/IComponent.h}
...
\lstinputlisting[language=C++, caption={Display controller}, label={lst:cpp_display}, style=mystyle]{../code/Display.h}
