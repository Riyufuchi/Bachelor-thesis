...
\begin{document}
	...
	\chapter{Předmluva}
	\section {Úvod}
	Téma mojí bakalářské práce je “Návrh zařízení pro testování nabíjecích kabelů”. Toto zařízení bude řízeno jednodeskovým počítačem Arduino (\ardMeg). Arduino se programuje pomocí jazyka C/C++ a je open source. Toto zařízení se bude testovat a následně používat v reálném prostředí.
